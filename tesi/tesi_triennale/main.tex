...
\lstset{
    style=codeStyle,
    inputencoding=utf8,        % Forza la codifica UTF-8
    extendedchars=true,        % Permette caratteri estesi
    % Il comando seguente mappa i caratteri speciali comuni che spesso rompono il codice
    literate={à}{{\`a}}1 {è}{{\`e}}1 {é}{{\'e}}1 {ì}{{\`i}}1 {ò}{{\`o}}1 {ù}{{\`u}}1 {°}{{\textdegree}}1 {test}{{\"o}}1,
}
