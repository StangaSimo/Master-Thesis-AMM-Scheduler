...
\item \textbf{Coordinator}: The Coordinator (represented in Fig. \ref{figcoordinator}) acts as the brain of the scheduler. It decides how to dispatch tasks and implements different strategies to demonstrate various resource management techniques. 
    ...
    Finally, the Coordinator supports the Task Splitting logic. If a matrix exceeds the memory capacity of a single accelerator, the logic breaks it down into smaller sub-tasks such that they may be distributed across multiple accellerators (see Sec. \ref{impllargelogic}, Large Matrix Split).
